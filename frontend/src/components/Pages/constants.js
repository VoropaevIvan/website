...
export const DEFAULT_TASK_TEXT = "Введите условие задачи...";
export const DEFAULT_SOLVE_FOR_TASK_TEXT = "Введите решение на задачу...";
...
export const LITTLE_HARD_THEN_EGE = "Чуть сложнее ЕГЭ";
